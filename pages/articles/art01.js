			...
			<main className='h-full w-full bg-gray-50 flex items-center justify-center'>
				<div className='border max-w-screen-md bg-white mt-6 rounded-2xl p-4'>
					<div className='flex items-center	justify-between'>
						<div className='gap-3.5	flex items-center '>
							...
							<div className='flex flex-col'>
								<b className='mb-2 capitalize'>Admin</b>
                    ...
                    <h1 className='text-1xl font-black antialiased'>บทความสล็อตออนไลน์</h1>
						<span>
							เกมสล็อตออนไลน์ที่ได้รับความนิยม การเล่นเกมสล็อตออนไลน์นั้น มีวิธีการเล่นที่ง่ายมาก ๆ ไม่กี่ขั้นตอน แต่การเล่น <strong>pgslot online</strong>
							อย่างไรให้เข้าใจและเล่นอย่างมีกลยุทธ์ จะเพิ่มโอกาสให้คุณได้รับเงินรางวัลมากยิ่งขึ้น แท้จริงแล้ว การเล่น <strong>pgslot</strong>
							ผู้เล่นจะต้องศึกษากฏกติกาการเล่น อัตราการจ่าย สัญลักษณ์พิเศษ รวมถึงโบนัสและรางวัลแจ็คพอต ที่จะทำให้คุณรวยได้จากการเล่นสล็อตออนไลน์กับ
						</span>
					</div>
					<div className='mt-5 flex gap-2	 justify-center border-b pb-4 flex-wrap	'>
						<img
							src='/img/article/pgslot1.jpg'
							className='bg-red-500 rounded-2xl object-cover w-full h-auto flex-auto'
							alt='บทความ pgslot'
						/>
